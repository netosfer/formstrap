...
```php
Formstrap::text('username', 'Username')
```
...
```bash
composer require netosfer/formstrap
```
...
'providers' => [
    //...
	Netosfer\Formstrap\FormstrapServiceProvider::class,
],
```
...
{!!Formstrap::open()->formInline()!!}

// You can use FALSE to turn off disable form inline
{!!Formstrap::open()->formInline(false)!!}
```
...
```php
// Example
{!!Formstrap::fieldsetOpen('Legend title')!!}
// ... fieldset content
{!!Formstrap::fieldsetClose()!!}
```
...
```php
// Example
{!!Formstrap::textarea('description', 'Description')!!}
```
...
```php
// Example
{!!Formstrap::select('city', 'Choose your city', [1 => 'Gotham City', 2 => 'Springfield'])!!}
```
...
// With array
{!!Formstrap::select('city', 'Choose your city')->options([1 => 'Gotham City', 2 => 'Springfield'])!!}

// With collection
$cities = collect([1 => 'Gotham City', 2 => 'Springfield'])
{!!Formstrap::select('city', 'Choose your city')->options($cities)!!}
...
$cities = \App\City::all();
{!!Formstrap::select('city', 'Choose your city')->options($cities, 'city_name', 'id_object_field')!!}
...
$cities = \App\City::all();
{!!Formstrap::select('city', 'Choose your city')->options($cities->prepend('Choose your city', ''))!!}
```
...
```php
// Example
{!!Formstrap::checkbox('orange', 'Orange')!!}
```
...
```php
// Example
{!!Formstrap::date('birthday', 'Birthday')!!}
```
...
```php
// Example
{!!Formstrap::tel('number', 'Phone number')!!}
```
...
```php
// Example
{!!Formstrap::time('hour', 'Meeting hour')!!}
```
...
```php
// Example
{!!Formstrap::urlInput('website', 'You website')!!}
```
...
```php
// Example
{!!Formstrap::range('name', 'User name')!!}
```
...
```php
// Example
{!!Formstrap::anchor("Link via parameter", 'foo/bar')!!}
```
...
```php
// Example
{!!Formstrap::button("Do something", "warning", "lg")!!}
```
...
```php
// Example
{!!Formstrap::anchor("Link via url")->url('foo/bar')!!}
```
...
```php
// Example
{!!Formstrap::anchor("Link via route")->route('home')!!}
```
...
{!!Formstrap::open()->route('register.post')->errorBag("registerErrorBag")!!}
...
```php
// Example
{!!Formstrap::errors("The form has errors")!!}
```
...
```php
// Example
{!!Formstrap::text('username', 'User name')->disableValidation()!!}

// You can use FALSE to turn off disable validation (to enable it)
{!!Formstrap::text('username', 'User name')->disableValidation(false)!!}
```
...
{!!Formstrap::checkbox('agree', 'I agree')->checked()!!}

// You can use FALSE to turn off checked status
{!!Formstrap::checkbox('agree', 'I agree')->checked(false)!!}
```
...
```php
// Examples
{!!Formstrap::radio('orange', 'Orange')->inline()!!}

{!!Formstrap::checkbox('orange', 'Orange')->inline()!!}

// You can use FALSE to turn off inline status
{!!Formstrap::checkbox('orange', 'Orange')->inline(false)!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Name')->placeholder('Input placeholder')!!}
```
...
```php
// Example
{!!Formstrap::select('city', 'Choose your city', [1 => 'Gotham City', 2 => 'Springfield'])->multiple()!!}
```
...
```php
// Example
{!!Formstrap::open()->locale('forms.user')!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Name')->help('Help text here')!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Name')->attrs(['data-foo' => 'bar', 'rel'=> 'baz'])!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Name')->wrapperAttrs(['data-foo' => 'bar', 'id'=> 'name-wrapper'])!!}
```
...
// Using readonly field
{!!Formstrap::text('name', 'Name')->readonly()!!}

// You can use FALSE to turn off readonly status
{!!Formstrap::text('name', 'Name')->readonly(false)!!}
```
...
// Disabling a field
{!!Formstrap::text('name', 'Name')->disabled()!!}

// Disabling a fieldset
{!!Formstrap::fieldsetOpen('User data')->disabled()!!}

// You can use FALSE to turn off disabled status
{!!Formstrap::text('name', 'Name')->disabled(false)!!}
```
...
// Disabling a field
{!!Formstrap::text('name', 'Name')->block()!!}

// You can use FALSE to turn off block status
{!!Formstrap::text('name', 'Name')->block(false)!!}
```
...
// Disabling a field
{!!Formstrap::text('name', 'Name')->required()!!}

// Disabling a fieldset
{!!Formstrap::fieldsetOpen('User data')->required()!!}

// You can use FALSE to turn off required status
{!!Formstrap::text('name', 'Name')->required(false)!!}
```
...
{!!Formstrap::open()->autocomplete('off')!!}

// Explicitly set a autocomplete value
{!!Formstrap::text('mobile', 'Mobile Number')->autocomplete('tel')!!}

// Disable autocomplete for fields with valid names
{!!Formstrap::text('name', 'Name')->autocomplete('off')!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Name')->id('user-name')!!}
```
...
```php
// Example
{!!Formstrap::open()->idPrefix('register')!!}
```
...
```php
// Examples
{!!Formstrap::open()->multipart()!!}

// You can use FALSE to turn off multipart
{!!Formstrap::open()->multipart(false)!!}
```
...
```php
// Examples
{!!Formstrap::open()->method('get')!!}
{!!Formstrap::open()->method('post')!!}
{!!Formstrap::open()->method('put')!!}
{!!Formstrap::open()->method('patch')!!}
{!!Formstrap::open()->method('delete')!!}
```
...
{!!Formstrap::open()->post()!!}
{!!Formstrap::open()->put()!!}
{!!Formstrap::open()->patch()!!}
{!!Formstrap::open()->delete()!!}
```
...
```php
// Examples
{!!Formstrap::button("Do something")->color("warning")!!}

{!!Formstrap::button("Do something")->color("primary")!!}
```
...
```php
// Examples
{!!Formstrap::button("Button label")->warning()!!}
{!!Formstrap::button("Button label")->outline()!!}
{!!Formstrap::button("Button label")->success()!!
{!!Formstrap::button("Button label")->danger()!!}
{!!Formstrap::button("Button label")->secondary()!!}
{!!Formstrap::button("Button label")->info()!!}
{!!Formstrap::button("Button label")->light()!!}
{!!Formstrap::button("Button label")->dark()!!}
{!!Formstrap::button("Button label")->link()!!}
```
...
```php
// Examples
{!!Formstrap::button("Do something")->size("sm")!!}

{!!Formstrap::button("Do something")->size("lg")!!}
```
...
```php
// Examples
{!!Formstrap::button("Button label")->sm()!!}
{!!Formstrap::button("Button label")->lg()!!}
```
...
// Password field
{!!Formstrap::text('password', 'Your password')->type('password')!!}

// Number field
{!!Formstrap::text('age', 'Your age')->type('number')!!}

// Email field
{!!Formstrap::text('email', 'Your email')->type('email')!!}
```
...
```php
// Example
{!!Formstrap::text('age', 'Your age')->type('number')->min(18)!!}
```
...
```php
// Example
{!!Formstrap::text('age', 'Your age')->type('number')->max(18)!!}
```
...
```php
// Examples
{!!Formstrap::text('age')->label('Your age')!!}
```
...
```php
// Example
{!!Formstrap::text('name', 'Your name')->value('Maria')!!}
```
...
// Number field
{!!Formstrap::render('text')->name('age')->label('Your age')!!}
```
...
{!!Formstrap::text('name', 'Name')->disableIsValid()!!}
```
...
{!!Formstrap::open()->locale('forms.user')->put()->multipart()->route('user.add')->data($user)!!}

{!!Formstrap::text('name', 'Name')->placeholder('Type your name')->lg()!!}

{!!Formstrap::anchor("Link as a button")->sm()->info()->outline()!!}

{!!Formstrap::submit('Awesome button')->id('my-btn')->disabled()->danger()->lg()!!}
